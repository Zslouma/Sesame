...
namespace Syracuse.Mobitheque.Core.ViewModels
{
    public class PressDailyViewModel : BaseDownloadPageViewModel
    {
        ...
        public string DailyPressScenarioCode
        {
            get => this.dailyPressScenarioCode;
            set
            {
                SetProperty(ref this.dailyPressScenarioCode, value);
            }
        }
        ...
        public PressDailyViewModel(IMvxNavigationService navigationService, IRequestService requestService)
        {
        ...
        public async override Task Initialize()
        {
            ...
            this.DailyPressScenarioCode = user.DailyPressScenarioCode;
            this.SearchQuery = user.DailyPressQuery;
        ...
        private async Task<Result[]> loadPage()
        {
            ...
            options.Query = new SearchOptionsDetails()
            {
                ...
                ScenarioCode = this.DailyPressScenarioCode,
                Page = this.page,
            };
